...
function createPdfBinary(docDefinition) {
	var fonts = {
		...
		fzytk: {
			normal: path.join(__dirname, '..', 'examples', '/fonts/FZYTK.TTF'),
			bold: path.join(__dirname, '..', 'examples', '/fonts/FZYTK.TTF'),
			italics: path.join(__dirname, '..', 'examples', '/fonts/FZYTK.TTF'),
			bolditalics: path.join(__dirname, '..', 'examples', '/fonts/FZYTK.TTF')
		}
	};
